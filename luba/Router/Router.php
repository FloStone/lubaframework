...
class Router
{
	...
	public function routeController(Route $action)
	{
		...
		if (method_exists($controller, $method) or (class_exists(\Luba\AdminBackend::class) ? is_subclass_of($controller, \Luba\AdminBackend::class) : false) or $controller->isGlobal())
		{
